...
- name: Google Spectrum Database API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-spectrum-database/master/_listings/google-spectrum-database/verifydevice-post.md
x-common:

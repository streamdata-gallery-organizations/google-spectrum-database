---
name: Streadata.io API Gallery - Google Spectrum Database
description: This is a repository of google spectrum database APIs, self-contained
  as a Github repository, with HTML and YAML representations of the APIs and their
  surrounding operations.
image: http://template.streamdata.gallery/assets/google-spectrum-database.png
created: "2018-02-24"
modified: "2018-06-25"
url: http://google-spectrum-database.streamdata.gallery/apis.json
